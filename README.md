...
> Java 기반 백엔드 개발 경험을 바탕으로,현재는 ROS2, STM32, Raspberry Pi, Hailo-8 기반의 지능형 임베디드 시스템 개발로 영역을 확장하고 있습니다.
> 서버–디바이스 연동 경험을 토대로 하드웨어와 소프트웨어가 결합된 시스템을 직접 설계·구현하고 있습니다.
