...
- 🧠 **YOLOv8-Pose + Hailo-8 Edge AI**로 전신 포즈 랜드마크 실시간 추출   
- 💪 **TCN 기반 시퀀스 모델**로 스쿼트·버피·레그레이즈 등 9종 운동 자동 분류  
- 🧪 **EMG·IMU 피처 + MLP 모델**로 피로도(FI)·불균형(BI) 지표 산출  
...
### 🧮 **Coding Test (알고리즘 연습)**
> 백준, 프로그래머스 문제 풀이 정리  
> C,C++ 기반으로 자료구조/알고리즘 기초 다지기  

📂 Repository: [coding_test](https://github.com/JeongMinLim-0121/coding_test)
